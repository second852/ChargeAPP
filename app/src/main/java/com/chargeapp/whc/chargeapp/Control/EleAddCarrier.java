...
public class EleAddCarrier extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        final String url = "https://api.einvoice.nat.gov.tw/PB2CAPIVAN/APIService/PB2CAPIVAN/APIService/carrierLinkBlank?UUID=second&appID=EINV3201711184648&CardCode=3J0002&CardNo=/2RDO8+P&VerifyCode=531d";
